...
public class ParallelIndividualConnection : MonoBehaviour
{
    [SerializeField]
    ...
    public void MoveRehostatWithSlider(float newSliderPos)
    {
        ...
        rehostatHandle.position = new Vector3(rehostatHandle.transform.position.x, rehostatHandle.transform.position.y, newSliderPos);
        ...
        //ammeterReading = roundedSliderPos;
        ...
        voltmeterReading = posNum * 8;
        ammeterReading = voltmeterReading / parallelResistorValue;
